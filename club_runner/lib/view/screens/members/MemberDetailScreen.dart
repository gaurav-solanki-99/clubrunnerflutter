          ...
          child: Column(
            children: [
              Text(
                "EDENVALE MARATHON",
                style: MyTextStyle.textStyle(
                    FontWeight.w600, fontSize * 4.7,MyColor.app_white_color),
              ),
              SizedBox(
                height: heightPerBox! * 1,
              ),
              RichText(
                text: TextSpan(
                  text: "SUN",
                  style: MyTextStyle.textStyle(
                      FontWeight.w600, fontSize* 4,MyColor.app_white_color),
                  children: <TextSpan>[
                    TextSpan(
                        text: " 5NOV 2024 ",
                        style: MyTextStyle.textStyle(
                    ...
                    TextSpan(
                        text: "- 4:34p/km ",
                        style: MyTextStyle.textStyle(
                            FontWeight.w200, fontSize* 4,MyColor.app_white_color)),
                    TextSpan(
                        text: "- 42.2 KM ",
                        style: MyTextStyle.textStyle(
                            FontWeight.w300, fontSize* 4,MyColor.app_white_color)),
